...
public class GlobalException {
	...
	public ResponseEntity<MyErrorDetails> exceptionHandler5(StudentException ce, WebRequest req) {
		MyErrorDetails err = new MyErrorDetails();
		err.setTimestamp(LocalDateTime.now());
	...
	public ResponseEntity<MyErrorDetails> exceptionHandler5(TeacherException ce, WebRequest req) {
		MyErrorDetails err = new MyErrorDetails();
		err.setTimestamp(LocalDateTime.now());
		err.setMessage(ce.getMessage());
		err.setDescription(req.getDescription(false));
	...
	public ResponseEntity<MyErrorDetails> exceptionHandler5(CourseException ce, WebRequest req) {
		MyErrorDetails err = new MyErrorDetails();
		err.setTimestamp(LocalDateTime.now());
		err.setMessage(ce.getMessage());
		err.setDescription(req.getDescription(false));
	...
	public ResponseEntity<MyErrorDetails> exceptionHandler5(BatchException ce, WebRequest req) {
		MyErrorDetails err = new MyErrorDetails();
		err.setTimestamp(LocalDateTime.now());
		err.setMessage(ce.getMessage());
		err.setDescription(req.getDescription(false));
